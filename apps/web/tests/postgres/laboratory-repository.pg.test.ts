...
//
// Se prueba acá y no con mocks porque lo que decide el resultado son los DOS
// índices únicos PARCIALES de la tabla —`searchKey` y `createCommandKey`— y un
// mock no choca contra un índice. Ese fue exactamente el hueco: la suite
