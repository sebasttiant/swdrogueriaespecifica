...
// La membresía del grupo pertenece al servidor. El cliente solo identifica el
// grupo por su clave canónica; nunca puede escoger un subconjunto de reportes.
const missingReportGroupKey = z
  .string()
  .trim()
  .min(1, { error: "Falta el grupo de reportes." })
  .max(MAX_MISSING_REPORT_NAME_LENGTH, { error: "El grupo de reportes no es válido." });
...
// Resolución rápida de un grupo de reportes: solo su clave canónica y la
// decisión. Ni producto, ni cantidad, ni proveedor.
